...
if __name__ == "__main__":
    ...
    df_vec_url, df_url_scores = create_url_vector(atel_, data_path, file_dict_sens_inst, df_vec_init_pred, df_astrobert_source_types, df_sor)
