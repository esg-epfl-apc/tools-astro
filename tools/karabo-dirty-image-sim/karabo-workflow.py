...
survey = "gleam 72e6-231e6 Hz, RA[0.0,360.0]/DEC[-90.0,30.0] deg"  # http://odahub.io/ontology#String; oda:allowed_value 'gleam 72e6-231e6 Hz, RA[0.0,360.0]/DEC[-90.0,30.0] deg', 'mals-dr1v3 902e6-1644e6 Hz, RA[0.0,360.0]/DEC[-78.80,32.35] deg', 'mightee-l1 1304e6-1375e6 Hz, RA[149.40,150.84]/DEC[1.49,2.93] deg'.
start_freq = 72e6  # http://odahub.io/ontology#FrequencyHz; oda:lower_limit 30000; oda:upper_limit 30000000000
...
telescope = "ASKAP"  # http://odahub.io/ontology#String; oda:allowed_value 'ASKAP','MeerKAT','LOFAR','MKATPlus','PDBI','SKA1LOW','SKA1MID','VLBA','WSRT'.
field_of_view = 1.0  # http://odahub.io/ontology#AngleDegrees; oda:lower_limit 0.1; oda:upper_limit 10.0
