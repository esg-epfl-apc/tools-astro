...
_galaxy_meta_data = {}
_oda_outs.append(('out_Spectrum_folded_picture_png', 'picture_png_galaxy.output', picture_png))
_oda_outs.append(('out_Spectrum_folded_spectrum_astropy_table', 'spectrum_astropy_table_galaxy.output', spectrum_astropy_table))
