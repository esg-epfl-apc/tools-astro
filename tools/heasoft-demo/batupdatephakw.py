...
auxfile = (
    "NONE"  # oda:POSIXPath; oda:description "Auxiliary raytracing filename"
)
...
command = "batupdatephakw"
params_names = "infile,infile,auxfile,chatter,clobber,history,mode"
...
_galaxy_meta_data = {}
_oda_outs = []
_oda_outs.append(("out_batupdatephakw_result", "result_galaxy.output", result))
