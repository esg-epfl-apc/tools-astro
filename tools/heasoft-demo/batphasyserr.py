...
syserrfile = (
    "NONE"  # oda:POSIXPath; oda:description "Systematic error filename"
)
...
syserrfile = str(inp_pdic["syserrfile"])
...
command = "batphasyserr"
params_names = "infile,infile,syserrfile,chatter,clobber,history,mode"
...
_galaxy_meta_data = {}
_oda_outs = []
_oda_outs.append(("out_batphasyserr_result", "result_galaxy.output", result))
