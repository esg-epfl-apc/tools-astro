...
rows = "-"  # oda:String; oda:description "Range(s) of rows used for summing"
...
command = "batsumdph"
params_names = "infile,infile,outfile,rows,clobber,chatter,history,mode"
...
_galaxy_meta_data = {}
_oda_outs = []
_oda_outs.append(("out_batsumdph_result", "result_galaxy.output", result))
