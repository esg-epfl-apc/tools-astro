...
_oda_outs.append(
    (
        "out_Synchrotron_external_Compton_Bremsstrahlung_simple_spectrum_png",
...
_oda_outs.append(
    (
        "out_Synchrotron_external_Compton_Bremsstrahlung_simple_spectrum_table",
