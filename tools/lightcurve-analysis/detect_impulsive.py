...
if "C_data_product_" in inp_dic.keys():
    ...
    inp_pdic = inp_dic
light_curve = str(inp_pdic["light_curve"])
time_column = str(inp_pdic["time_column"])
rate_column = str(inp_pdic["rate_column"])
rate_err_column = str(inp_pdic["rate_err_column"])
