...
_galaxy_meta_data = {}
_oda_outs = []
_oda_outs.append(("out_CTAO_image_png", "image_png_galaxy.output", image_png))
_oda_outs.append(
    ("out_CTAO_theta2_png", "theta2_png_galaxy.output", theta2_png)
)
_oda_outs.append(
    ("out_CTAO_spectrum_png", "spectrum_png_galaxy.output", spectrum_png)
)
_oda_outs.append(
    (
        "out_CTAO_event_list_fits",
